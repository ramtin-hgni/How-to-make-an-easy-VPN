...
!(https://github.com/ramtin-hgni/How-to-make-an-easy-VPN/blob/3718776358f2bbdf5330874c5b4f9ad3a525d3c6/Screenshot%202026-09-03%20181512.png)
...
// https://github.com/zizifn/cloudflare-worker-vpn
```

> **Note:** For the full code, please visit [zizifn's repository](https://github.com/zizifn/cloudflare-worker-vpn) and copy the worker script.
...
| Field | Value |
|-------|-------|
| Address | Your Worker Address |
| Port | `443` |
| User ID | Your Generated UUID |
| Encryption | `none` |
| Transport | `ws` |
| Path | `/` |
| Security | `tls` |
